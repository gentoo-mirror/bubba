...
BASE_SERVER_URI="https://github.com/gordonb3"
HOMEPAGE="${BASE_SERVER_URI}/${PN}"
SRC_URI="${BASE_SERVER_URI}/${PN}/archive/${PVR}.tar.gz -> ${PF}.tar.gz"
...
src_install() {
	...
	elog "https://wiki.gentoo.org/wiki/Eix#Managing_the_cache"
	insinto "/etc/eixrc"
